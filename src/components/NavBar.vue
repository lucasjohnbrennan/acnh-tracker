  ...
  <header class="border-b border-stone-200 bg-white dark:border-stone-800 dark:bg-stone-900">
    <div class="mx-auto flex max-w-5xl flex-wrap items-center gap-3 px-4 py-3">
      ...
      <nav class="flex gap-4 text-sm font-medium text-stone-600 dark:text-stone-300">
        ...
        <router-link to="/fossils" class="hover:text-emerald-700 dark:hover:text-emerald-400" active-class="text-emerald-700 dark:text-emerald-400">Fossils</router-link>
        <router-link to="/art" class="hover:text-emerald-700 dark:hover:text-emerald-400" active-class="text-emerald-700 dark:text-emerald-400">Art</router-link>
