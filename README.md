...
A companion tracker for **Animal Crossing: New Horizons** that answers the
one question every time-traveling player actually has:

> *What month and hour should I jump to right now to catch the most stuff?*

**[Try it live →](https://lucasjohnbrennan.github.io/acnh-tracker/)**

## What it does

- **Tells you the single best time to time-travel to.** Every time you load
...
Catch data is sourced from the community-maintained ["Data Spreadsheet for
Animal Crossing New
...
Want to run this yourself, deploy your own copy, or see how it's built? See
